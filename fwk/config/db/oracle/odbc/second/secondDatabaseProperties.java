...
@ConfigurationProperties(prefix = secondDatabaseProperties.PREFIX)
public class secondDatabaseProperties implements DatabaseProperties {

    public static final String PREFIX = "datasource.second";
    ...
    public String toString() {
        return "NxmDevDatabaseProperties[" + this.driverClassName + "]";
    }
}
